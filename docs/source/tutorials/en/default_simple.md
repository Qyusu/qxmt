...
- **global_settings**: Defines global configuration parameters including:
  ...
  - `model_type`: Specifies the type of quantum model to use (currently supports "qkernel" or "vqe")
  - `task_type`: For qkernel models, specifies whether the task is "classification" or "regression"
