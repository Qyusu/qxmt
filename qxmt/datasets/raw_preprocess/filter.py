...
def filter_by_categorical(
    X: np.ndarray, y: np.ndarray, n_samples: int, random_seed: int, drop_na: bool = True
) -> RAW_DATASET_TYPE:
    ...
    indices = rng.choice(X_filtered.shape[0], n_samples, replace=False)
